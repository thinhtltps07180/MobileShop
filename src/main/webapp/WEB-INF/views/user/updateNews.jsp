	...
	<div class="container">
		<div class="row">
			<div class="col-12 grid-margin stretch-card">
					<h3>Create News</h3>
					<h3>${message}</h3>
					<form:form enctype="multipart/form-data" action="/user/updateNews"
						modelAttribute="updateNews" class="row login_form" id="register_form">
						<div class="col-md-12 form-group">
							<form:input type="hidden" path="id" class="form-control" id="name"
