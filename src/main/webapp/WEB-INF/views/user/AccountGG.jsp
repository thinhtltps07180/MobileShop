		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="login_form_inner register_form_inner">
					...
					<h3>${message}</h3>
					<form:form enctype="multipart/form-data" action="/user/CreateGG"
						modelAttribute="usergg" class="row login_form" id="register_form">
						...
						<div class="col-md-12 form-group">
							<input path="email" type="email" class="form-control" id="email"
								name="email" placeholder="Email" onfocus="this.placeholder = '${usergg.email}'"
								onblur="this.placeholder = 'Email'" value="${usergg.email}">
