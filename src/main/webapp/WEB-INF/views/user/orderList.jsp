...
<div class="main-panel">
	<div class="content-wrapper">
		<div class="page-header">
			<h3 class="page-title">Orders have status Delivery</h3>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="#">Tables</a></li>
					<li class="breadcrumb-item active" aria-current="page">Orders
						have status Delivery</li>
				</ol>
			</nav>
		</div>
		<div class="row">
					...
					<div class="card-body">
						...
						<div class="table-responsive">
							<table id="example" class="table">
								...
								<tbody>
									<c:forEach var="o" items="${listDetailByUser}" varStatus="loopCounter">
										<tr>
											<td>${o.id}</td>
											<td>${o.user.id}</td>
											<td>${o.orderDate}</td>
											...
											<td><a href="/user/orderDetail/${o.id}/${o.id}">Detail</a>
										</tr>
									</c:forEach>
								</tbody>
							</table>
