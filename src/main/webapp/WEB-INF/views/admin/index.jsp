				...
				<div class="card bg-gradient-danger card-img-holder text-white">
					<div class="card-body">
						...
						<h4 class="font-weight-normal mb-3">
							Daily Sales <i class="mdi mdi-chart-line mdi-24px float-right"></i>
						</h4>
						<c:forEach var="array" items="${rnvDay}">
							<h3 class="mb-5">${array[0]}</h3>
							<h2 class="mb-5">
				...
				<div class="card bg-gradient-success card-img-holder text-white">
					<div class="card-body">
						<img src="/static/admin/assets/images/dashboard/circle.svg"
							class="card-img-absolute" alt="circle-image">
						<h4 class="font-weight-normal mb-3">
							Order by month <i class="mdi mdi-diamond mdi-24px float-right"></i>
						</h4>
			...
			<div class="col-md-7 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						...
						<div class="clearfix">
							<h4 class="card-title float-left">Daily Sales Statistics bar-char </h4>
			...
			<div class="col-md-5 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						...
						<canvas id="piechart"
							class="chartjs-render-monitor"style="display: block; height: 350px; width: 391px;">
						</canvas>
					</div>
				</div>
			</div>
