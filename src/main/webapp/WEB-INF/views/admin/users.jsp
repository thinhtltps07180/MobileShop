...
<link rel="shortcut icon"
	href="/static/admin//static/admin/assets/images/favicon.png" />
		...
		<nav
			...
			<div
				...
				<a class="navbar-brand brand-logo" href="index.html"><img
					src="/static/admin/assets/images/logo.svg" alt="logo" /></a> <a
					class="navbar-brand brand-logo-mini" href="index.html"><img
					src="/static/admin/assets/images/logo-mini.svg" alt="logo" /></a>
			</div>
					...
					<li class="nav-item nav-profile dropdown"><a
						...
						data-toggle="dropdown" aria-expanded="false">
							<div class="nav-profile-img">
								<img src="/static/admin/assets/images/faces/face1.jpg"
						...
						<div
							...
							<a class="dropdown-item preview-item">
								<div class="preview-thumbnail">
									<img src="/static/admin/assets/images/faces/face4.jpg"
							...
							<a class="dropdown-item preview-item">
								<div class="preview-thumbnail">
									<img src="/static/admin/assets/images/faces/face2.jpg"
										alt="image" class="profile-pic">
								</div>
								<div
									class="preview-item-content d-flex align-items-start flex-column justify-content-center">
							...
							<a class="dropdown-item preview-item">
								<div class="preview-thumbnail">
									<img src="/static/admin/assets/images/faces/face3.jpg"
										alt="image" class="profile-pic">
								</div>
								<div
									class="preview-item-content d-flex align-items-start flex-column justify-content-center">
